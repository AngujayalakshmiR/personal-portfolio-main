  ...
  <footer id="contactMe" className="bg-gray-900 sm:px-16 px-6">
    ...
    >
      <div className={` ${layout.sectionInfo}`}>
        <h2 className="text-xl font-bold text-[#5ce1e6] font-poppins hover:text-[#4bc8cd]">
          {aboutMe.name}
        </h2>
        <p
        ...
        <div className="flex flex-row mt-4">
          {socialMedia.map((social, index) => (
            <a
              ...
              key={social.id}
              index={index}
              className="text-white mr-5 text-[25px] w-[25px] h-[25px] hover:text-teal-200"
            >
    ...
    <div className="text-center font-poppins font-normal text-dimWhite text-xs sm:text-sm pb-4">
      <p>
        Made with 💙 by Angu jayalakshmi R
      </p>
    </div>
  </footer>
);
